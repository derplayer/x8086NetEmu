...
namespace x8086SharpEmu
{
    public class KeyMap
    {
        ...
        public KeyMap()
        {
            ...
            keytbl[(int)Keys.Divide] = (int)(53 | KEY_EXTEND);
            ...
            keytbl[(int)Keys.Home] = (int)(71 | KEY_EDIT | KEY_NOSHIFT);
            keytbl[(int)Keys.NumPad8] = 72;
            keytbl[(int)Keys.Up] = (int)(72 | KEY_EXTEND | KEY_NONUM);
            keytbl[(int)Keys.NumPad9] = 73;
            keytbl[(int)Keys.PageUp] = (int)(73 | KEY_EDIT);
            keytbl[(int)Keys.Subtract] = 74;
            keytbl[(int)Keys.NumPad4] = 75;
            keytbl[(int)Keys.Left] = (int)(75 | KEY_EXTEND | KEY_NONUM);
            keytbl[(int)Keys.NumPad5] = 76;
            keytbl[(int)Keys.NumPad6] = 77;
            keytbl[(int)Keys.Right] = (int)(77 | KEY_EXTEND | KEY_NONUM);
            keytbl[(int)Keys.Add] = 78;
            keytbl[(int)Keys.NumPad1] = 79;
            keytbl[(int)Keys.End] = (int)(79 | KEY_EDIT);
            keytbl[(int)Keys.NumPad2] = 80;
            keytbl[(int)Keys.Down] = (int)(80 | KEY_EXTEND | KEY_NONUM);
            keytbl[(int)Keys.NumPad3] = 81;
            keytbl[(int)Keys.PageDown] = (int)(81 | KEY_EDIT);
            keytbl[(int)Keys.NumPad0] = 82;
            keytbl[(int)Keys.Insert] = (int)(82 | KEY_EDIT);
            keytbl[(int)Keys.Decimal] = 83;
            keytbl[(int)Keys.Delete] = (int)(83 | KEY_EDIT);
